  ...
  <div class="py-6">
    <div class="mx-auto px-3 xl:container sm:px-4 xl:px-2">
      <div class="flex flex-row flex-wrap">
        ...
        <!-- sidebar -->
        <div
          class="order-first w-full max-w-full flex-shrink lg:w-1/3 lg:pb-8 lg:pr-8 lg:pt-14"
        >
...
const { data: posts } = await useFetch(
  "http://localhost:8080/ghost/api/content/posts/?key=5c2ee25d9a6c47d0cd7f9ac970&order=published_at%20desc&limit=7&include=tags,authors&filter=tag:lifestyle",
);
