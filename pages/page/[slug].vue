<template>
  ...
  <div v-if="tags" class="bg-gray-50 py-6">
    <div class="mx-auto px-3 xl:container sm:px-4 xl:px-2">
      <div class="flex flex-row flex-wrap">
        <!-- Left -->
...
const { data: tags, error } = await useFetch(
  `http://localhost:8080/ghost/api/content/tags/slug/${slug}/?key=5c2ee25d9a6c47d0cd7f9ac970`,
);

const { data: posts } = await useFetch(
  `http://localhost:8080/ghost/api/content/posts/?key=5c2ee25d9a6c47d0cd7f9ac970&order=published_at%20desc&include=tags,authors&filter=tag:${slug}`,
);
